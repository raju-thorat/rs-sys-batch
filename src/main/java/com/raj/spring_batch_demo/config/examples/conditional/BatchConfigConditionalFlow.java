...
@Configuration
@Slf4j
@ConditionalOnExpression("'${batch.example}' == 'conditional'")
public class BatchConfigConditionalFlow {
    ...
    public Job job1(JobRepository jobRepository,
        ...
        return new JobBuilder("job1", jobRepository)
                ...
                .from(step2(jobRepository, transactionManager))
                    .on(BatchStatus.COMPLETED.name()).to(step3(jobRepository, transactionManager))
                .from(step2(jobRepository, transactionManager))
